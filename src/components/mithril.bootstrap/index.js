...
var accordion = (function() {
  return {
    ...
    view: function(ctrl, content) {
      return m('.accordion.panel.panel-default', content.map(function(line,id){
...
me.element = me.element || function(a,b){return b;};
module.exports = {
  accordion: me.element('accordion', accordion),
  jumbotron: me.element('jumbotron', jumbotron),
  modal: me.element('modal', modal),
  tabset: me.element('tabset', tabset)
};
